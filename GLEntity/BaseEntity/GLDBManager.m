...
@interface TNCDBManager ()

@property (nonatomic, strong) FMDatabaseQueue* fmdbQueue;

@end

@implementation TNCDBManager
...
{
    static TNCDBManager* dbManager = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        dbManager = [[TNCDBManager alloc] init];
    });
    return dbManager;
}
...
- (BOOL)addColumsIfNeededOfEntity:(TNCBaseEntity*)entity withDB:(FMDatabase*)db
{
...
- (BOOL)createTableByEntity:(TNCBaseEntity*)entity withDB:(FMDatabase*)db
{
